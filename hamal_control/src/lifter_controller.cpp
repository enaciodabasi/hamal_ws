...
#include "hamal_control/lifter_controller.hpp"
...
namespace hamal_lifter_controller
{
    ...
    )
    {
        ...
        m_LifterActionServer->registerGoalCallback(boost::bind(&LifterController::lifterActionGoalCallback, this));

    }   

    void LifterController::update(const ros::Time& time, const ros::Duration& period)
    {   
    ...
    void LifterController::starting(const ros::Time& time)
    {
    ...
    void LifterController::stopping(const ros::Time& time)
    {
        m_LifterActionServer->shutdown();
    }

    void LifterController::lifterActionGoalCallback()
    {
    ...
    const double LifterController::calculateRequiredOperationDuration()
    {
    ...
    Commands LifterController::computeCommands(
    ...
    void LifterController::checkLimits(Commands& commands)
    {
...
PLUGINLIB_EXPORT_CLASS(
    hamal_lifter_controller::LifterController, controller_interface::ControllerBase
);